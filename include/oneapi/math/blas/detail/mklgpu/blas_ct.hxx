...
void dot(backend_selector<backend::mklgpu> selector, std::int64_t n, sycl::buffer<sycl::half, 1>& x,
         std::int64_t incx, sycl::buffer<sycl::half, 1>& y, std::int64_t incy,
         sycl::buffer<sycl::half, 1>& result) {
    oneapi::math::blas::mklgpu::MAJOR::dot(selector.get_queue(), n, x, incx, y, incy, result);
}

void dot(backend_selector<backend::mklgpu> selector, std::int64_t n, sycl::buffer<bfloat16, 1>& x,
...
sycl::event dot(backend_selector<backend::mklgpu> selector, std::int64_t n, const sycl::half* x,
                std::int64_t incx, const sycl::half* y, std::int64_t incy, sycl::half* result,
                const std::vector<sycl::event>& dependencies) {
    return oneapi::math::blas::mklgpu::MAJOR::dot(selector.get_queue(), n, x, incx, y, incy, result,
                                                  dependencies);
}

sycl::event dot(backend_selector<backend::mklgpu> selector, std::int64_t n, const bfloat16* x,
